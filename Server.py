...
# Index 3 is piece id
# Index 4 is image id
white = [0, [[0, 420, 16, 7], [60, 420, 17, 7], [120, 420, 18, 7], [180, 420, 19, 7], [240, 420, 20, 7], [300, 420, 21, 7], [360, 420, 22, 7], [420, 420, 23, 7], [0, 480, 24, 8], [60, 480, 25, 9], [120, 480, 26, 10], [180, 480, 27, 11], [240, 480, 28, 12], [300, 480, 29, 10], [360, 480, 30, 9], [420, 480, 31, 8]]]
black = [1, [[0, 120, 8, 6], [60, 120, 9, 6], [120, 120, 10, 6], [180, 120, 11, 6], [240, 120, 12, 6], [300, 120, 13, 6], [360, 120, 14, 6], [420, 120, 15, 6], [0, 60, 0, 1], [60, 60, 1, 2], [120, 60, 2, 3], [180, 60, 3, 4], [240, 60, 4, 5], [300, 60, 5, 3], [360, 60, 6, 2], [420, 60, 7, 1]]]
    ...
    while True:
        try:
            ...
            if not new_data:
                ...
                if player == 0:
                    reply = pickle.dumps(pieces[1])  # Return Black Data
                else:
